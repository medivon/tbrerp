      ...
      >
        <div className="flex min-w-0 items-start justify-between gap-4 border-b border-border bg-subtle px-4 py-3">
          <div className="min-w-0">
            <h2
              className="break-words text-base font-extrabold leading-7 text-foreground [overflow-wrap:anywhere]"
              id={titleId}
            >
              {title}
            </h2>
            <p
              className="mt-1 break-words text-sm font-semibold leading-6 text-muted-foreground [overflow-wrap:anywhere]"
              id={descriptionId}
            >
              {description}
            </p>
