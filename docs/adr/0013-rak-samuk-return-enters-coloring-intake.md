...
- Let internal staff choose a return destination each time.
- Return the work to the department that originally sent it.
- Always route received-back Rak Samuk work to coloring intake.
