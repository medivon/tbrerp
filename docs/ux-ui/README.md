...
- `design-system/`: shared visual design system, responsive/mobile guidance, page-level visual guidance, app shell, and reusable UI behavior such as table pagination. Start visual implementation references with `design-system/visual-design-system.md`, use `design-system/responsive-mobile.md` for viewport behavior, then use the matching file under `design-system/pages/` when designing a specific domain area.
