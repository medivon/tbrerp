...
2. ORD-240520-014, ลูกค้า ร้านบ้านศิลป์, โต๊ะกลางลงรักสมุก, JOB-O-0238, วันที่รับงาน 10 พ.ค. 67, กำหนดส่ง 24 พ.ค. 67, chips: พร้อมสร้างรอบจัดส่ง, มีงานสั่งทำ, COD, current state: รอสร้างรอบจัดส่ง, action: เปิดออเดอร์
3. ORD-240518-009, ลูกค้า คุณพิมพ์ชนก, ชุดเก้าอี้พร้อมส่ง, วันที่รับงาน 11 พ.ค. 67, กำหนดส่ง 23 พ.ค. 67, Order status: กำลังดำเนินการ, shipment chip: รอยืนยันการจัดส่ง, current state: เพิ่มเลขติดตามพัสดุ / หลักฐานขนส่ง, action: เปิดออเดอร์
