...
The old mockup image files for this screen are archived under `docs/archive/mockups/SCR-SHIP-001-ready-to-ship-queue/` when images exist. Archived images are historical visual references only. They are not active source of truth and must not override current UX, function, permission, or QA decisions.

Archived image files:

- `docs/archive/mockups/SCR-SHIP-001-ready-to-ship-queue/SCR-SHIP-001-content-approved.png`
