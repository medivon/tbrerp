...
- It supports both Product Model / `SKU ใหญ่` and SKU Variant / `SKU ย่อย` image contexts.
...
Future prompts for this screen must keep the grouped image-management workbench structure and must not turn the page into a product detail form, gallery landing page, or stock screen.
