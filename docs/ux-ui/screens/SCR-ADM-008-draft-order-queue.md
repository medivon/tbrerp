...
- See which drafts are old, incomplete, or owned by another admin.
...
| Draft owner | ผู้รับผิดชอบหลัก | แอดมินแพร | Owner | Traceability only. |
...
| Open draft | เปิดร่าง | Creator, same-permission, higher-permission | Opens Order Create/Edit for the saved draft. | No |
| Continue draft | ทำต่อ | Creator, same-permission, higher-permission | Opens saved draft at last workable section. | No |
...
- Draft creator can edit active draft.
- Same-permission users can continue active draft.
- Higher-permission users can continue active draft.
...
- Show owner but do not make the row feel locked to that owner.
