...
- Avoid customer private data and sales price.
...
- Customer private data, Customer phone/address, CRM notes, sales price, payment data, and Rak Samuk payout/rates are hidden.
