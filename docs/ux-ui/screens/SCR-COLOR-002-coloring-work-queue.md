...
- Avoid customer private data, Order ID, payment data, and sales price.
...
- Customer private data, Order ID, Customer phone/address, CRM notes, payment data, sales price, and Rak Samuk payout/rates are hidden.
