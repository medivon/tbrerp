...
- Responsible Delivery Team where the delivery workflow exposes the document
...
|---|---|---|---|---|
| Print Delivery Note | พิมพ์ใบส่งของ | Admin / responsible Delivery Team where allowed | Opens print for Delivery Note only. | No |
| Print both documents | พิมพ์ใบส่งของและใบจัดส่ง | Admin / responsible Delivery Team where allowed | Opens combined print flow. | No |
| Open Shipping Sheet | ดูใบจัดส่ง | Admin / responsible Delivery Team where allowed | Opens Shipping Sheet Preview. | No |
