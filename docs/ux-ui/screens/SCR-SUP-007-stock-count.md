...
| Close count | ปิดรอบนับ | Stock permission | Creates Stock Movement for every counted SKU and marks `นับเสร็จแล้ว`. | Yes |
| Cancel count | ยกเลิกรอบนับ | Stock permission / manager | Cancels round before movement creation. | Yes |
